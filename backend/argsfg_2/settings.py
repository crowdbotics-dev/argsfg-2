"""
Django settings for argsfg_2 project.
...
WSGI_APPLICATION = 'argsfg_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "argsfg_2 API",
    "DESCRIPTION": "API documentation for argsfg_2 App",
    "VERSION": "v1",
}
